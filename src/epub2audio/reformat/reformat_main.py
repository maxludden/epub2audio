...
def main(
    ...
    *,
    ...
    with progress:
        ...
        progress.update(convert_task, advance=1, description="convert chapters from HTML")
        copy_chapters_from_toc(
            stem,
            base_dir=base_dir,
        )
        progress.update(convert_task, advance=1, description="converting chapter to Markdown")
        markdown_paths = convert_chapters_to_markdown(
            stem,
            base_dir=base_dir,
        )
        progress.update(convert_task, advance=1, description="Finished converting to markdown.")
...
if __name__ == "__main__":
    ...
    main('/Users/maxludden/dev/py/epub2audio/static/defiance_of_the_fall_06/epub/defiance_of_the_fall_06.epub')
